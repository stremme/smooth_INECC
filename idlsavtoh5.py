...
#filenameidl='no2matrix_TROP_RM_2005_f.idl'
#filenameidl='so2_PBL_matrix_TROP_RM_2005_f.idl'
datasetname='hchomatrix_aver'
filenameidl='hcho_matrix_TROP_RM_2005_f.idl'
filelist=glob.glob(pathin+'/*.idl')
for filenameidlfull in filelist:
